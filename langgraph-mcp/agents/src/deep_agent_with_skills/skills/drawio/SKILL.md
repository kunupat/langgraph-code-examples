...
For all the architecture diagrams, follow these layout principles to ensure clarity:

### Component Arrangement
- **Central System**: Place the main system/boundary in the center
- **Radial Distribution**: Arrange external components around the center in a clockwise or balanced pattern
- **Consistent Spacing**: Maintain adequate padding between components so that they do not visually overlap or create cluttered areas
- **Diagonal Placement**: Position components diagonally from each other to minimize line crossings
- **size**: Ensure components are large enough to contain their labels with padding, but not so large that they dominate the diagram

### Connection Guidelines
- Use **orthogonal edges** (`edgeStyle=orthogonalEdgeStyle`) for clean, right-angled connections
- Set **rounded=0** and **jettySize=auto** for optimal orthogonal routing
- Keep **strokeColor=#666666** for consistent, subtle connection lines
- Label connections clearly but concisely to explain the relationship purpose
- Arrange connections to avoid overlaps and ensure arrowheads are visible (leave at least 20px of straight segment before the target)
- Use straight connections where possible, and add explicit waypoints to route around other components when necessary
...
### Example: Clear C4 Context Diagram Layout

Based on best practices for readable architecture diagrams, here's an improved layout for a Car Rental System C4 Context diagram:

```xml
<mxCell id="2" value="Car Rental System" style="shape=rectangle;rounded=1;whiteSpace=wrap;html=1;fillColor=#dae8fc;strokeColor=#6c8ebf;strokeWidth=2;" parent="1" vertex="1">
  <mxGeometry x="300" y="100" width="280" height="200" as="geometry"/>
</mxCell>
<!-- Customers at top-center -->
<mxCell id="3" value="Customers\n(Web/Mobile Apps)" style="shape=ellipse;whiteSpace=wrap;html=1;fillColor=#fff2cc;strokeColor=#d6b656;strokeWidth=2;" parent="1" vertex="1">
  <mxGeometry x="370" y="-10" width="140" height="60" as="geometry"/>
</mxCell>
<!-- Payment Service at right-center -->
<mxCell id="4" value="Payment Service\nProvider (Stripe/PayPal)" style="shape=rectangle;rounded=1;whiteSpace=wrap;html=1;fillColor=#d5e8d4;strokeColor=#82b366;strokeWidth=2;" parent="1" vertex="1">
  <mxGeometry x="740" y="160" width="160" height="80" as="geometry"/>
</mxCell>
<!-- Vehicle Inventory at bottom-right -->
<mxCell id="5" value="Vehicle Inventory\nSystem" style="shape=rectangle;rounded=1;whiteSpace=wrap;html=1;fillColor=#ffe6cc;strokeColor=#d79b00;strokeWidth=2;" parent="1" vertex="1">
  <mxGeometry x="520" y="370" width="160" height="80" as="geometry"/>
</mxCell>
<!-- Notification Service at bottom-left -->
<mxCell id="6" value="Notification\nService (Email/SMS)" style="shape=rectangle;rounded=1;whiteSpace=wrap;html=1;fillColor=#e4bdcc;strokeColor=#b85450;strokeWidth=2;" parent="1" vertex="1">
  <mxGeometry x="210" y="370" width="140" height="60" as="geometry"/>
</mxCell>
<!-- Admin Users at left-center -->
<mxCell id="7" value="Admin Users" style="shape=ellipse;whiteSpace=wrap;html=1;fillColor=#fff2cc;strokeColor=#d6b656;strokeWidth=2;" parent="1" vertex="1">
  <mxGeometry x="40" y="175" width="100" height="50" as="geometry"/>
</mxCell>
```

This arrangement prevents overlapping shapes and creates clear, readable connection paths.
